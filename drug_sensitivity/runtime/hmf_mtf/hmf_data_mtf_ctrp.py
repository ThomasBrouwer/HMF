...
Time taken: 58.5669391155 seconds. Average per iteration: 0.292834695578.
"""
...
C, D = [], []
R = [(R_gdsc,    M_gdsc,    'Cell_lines', 'Drugs', alpha_l[0]), 
     (R_ctrp,    M_ctrp,    'Cell_lines', 'Drugs', alpha_l[1]), 
     (R_ccle_ic, M_ccle_ic, 'Cell_lines', 'Drugs', alpha_l[2]),
     (R_ccle_ec, M_ccle_ec, 'Cell_lines', 'Drugs', alpha_l[3])]
