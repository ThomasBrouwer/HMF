...
using MF). We run ten repeats and average across them.
"""
...
main_dataset = 'D'
index_main = 2 # CCLE EC
file_performances = './results/hmf_data_mf_ccle_ic.txt'
...
for init in values_init:
    ...
    for n in range(n_repeats):
        ...
        HMF.initialise(init)
        HMF.run(iterations)
        all_performances.append(HMF.all_performances_Dl['MSE'][index_main])
