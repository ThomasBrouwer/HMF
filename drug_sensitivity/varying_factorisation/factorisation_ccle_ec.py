...
init = {
    'F'       : 'random', #'kmeans' gives error when CCLE IC,EC are both 'D' (no fully observed column in GDSC or CTRP)
    'Sn'      : 'random',
    'Sm'      : 'random',
    'G'       : 'random',
    'lambdat' : 'exp',
...
file_performance = 'results_ccle_ec.txt'
...
for factorisation in values_factorisation:
    main_dataset = factorisation['CCLE_EC']    
    index_main, R, C, D = construct_RCD(factorisation=factorisation, dataset_to_predict='CCLE_EC')
