...
the four drug sensitivity datasets, doing in-matrix predictions on the CTRP 
dataset.
'''
...
file_performance = 'results_ctrp.txt'
...
for factorisation in values_factorisation:
    main_dataset = factorisation['CTRP']    
    index_main, R, C, D = construct_RCD(factorisation=factorisation, dataset_to_predict='CTRP')
