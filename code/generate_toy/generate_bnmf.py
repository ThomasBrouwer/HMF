"""
Generate a toy dataset for the nonnegative matrix factorisation case, and store it.
U,V ~ Exp
"""
...
def generate_dataset(I,J,K,lambdaU,lambdaV,tau):
    ...
    for i,k in itertools.product(xrange(0,I),xrange(0,K)):
        U[i,k] = exponential_draw(lambdaU)
    V = numpy.zeros((J,K))
    for j,k in itertools.product(xrange(0,J),xrange(0,K)):
        V[j,k] = exponential_draw(lambdaV)
...
if __name__ == "__main__":
    output_folder = project_location+"bmf_models/data/toy/bnmf/"
