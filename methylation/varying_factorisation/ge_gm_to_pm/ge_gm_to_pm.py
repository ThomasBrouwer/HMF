'''
Script for trying different combinations of factorisations to predict the PM
values, given GE and GM values.
...
fout = open('results_ge_gm_to_pm_varying_factorisation.txt','w')
