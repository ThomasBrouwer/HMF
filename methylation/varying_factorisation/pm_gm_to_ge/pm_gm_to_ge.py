'''
Script for trying different combinations of factorisations to predict the GE
values, given PM and GM values.
...
fout = open('results_pm_gm_to_ge_varying_factorisation.txt','w')
